...
var_list1 = []
app.secret_key='a'
conn=ibm_db.connect("DATABASE=bludb;HOSTNAME=21fecfd8-47b7-4937-840d-d791d0218660.bs2io90l08kqb1od8lcg.databases.appdomain.cloud;PORT=31864;SECURITY=SSL;SSLServerCertificate=DigiCertGlobalRootCA.crt;UID=lzf12821;PWD=Nova02gvVYJfHVML",'','')
...
def register():
    ...
    if request.method == 'POST' :
        ...
        if account:
            ...
            email_from = 'nithya.anuki@gmail.com'
            epassword = 'dtrtyfkuygygyygg'
            email_to = email
